...
const hwDuskit = new Roaming("Skeleton Duskit (2020 Haloine's Nightmare)", 2048, true, false, false, false);
...
const xmasIkazune = new Roaming("Reindeer Ikazune (2020 Jolly Village)", 2048, true, true, false, false);
const nevermare = new Roaming("Nevermare (2021 Uhnne Fair)", 1024, true, true, true, false);
const hwIkazune = new Roaming("Skeleton Ikazune (2021 Uhnne Fair)", 3072, true, false, false, false);
const hwProtogon = new Roaming("Withered Protogon (2021 Uhnne Fair)", 6144, true, true, false, false);
const akhalos = new Roaming("Akhalos (2021 Jolly Village)", 1024, true, true, true, true);
const xmasMutagon = new Roaming("Gem Mutagon (2021 Jolly Village)", 1024, true, true, false, false);
...
const hwCephalops = new Roaming("Skeleton Cephalops (2022 Uhnne Fair)", 1024, true, false, false, false);
...
const hwDakuda = new Roaming("Skeleton Dakuda (2024 Trick Retreat)", 1, true, false, false, false);
const hwElephage = new Roaming("Pumpkin Elepehage (2024 Trick Retreat)", 1, true, true, false, false);
